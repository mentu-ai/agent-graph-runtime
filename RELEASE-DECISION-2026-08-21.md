...
## Decision A1, dated 2026-08-22 (early hours)

The author, presented with R7-EPOCH-DESIGN-2026-08-21.md sections 1-9,
confirms **Option A1: ship as-is, no r7 epoch, no gate amendment.**
Author's words: "Tu recomiendas A1? Usemos claude science cuando se
necesite" — A1 confirmed, with Claude Science epochs reserved for when
a review can change something rather than as ritual. This closes the
same-day reversal loop: the 2026-08-21 "Dale, trabajalo" authorization
of r7 preparation is superseded by this decision, informed by the
preparer's structural finding (release mode cannot address the current
candidate without a prior amendment) and by the governance layer's
standing answer (RELEASE-BOUNDARY-DECISION-2026-08-14: certified
review is not a release precondition; the release act is the gate).
Sections 1-4 of the design document stand as the record of why.
Decisions C and D are not required under A1. The released bytes are
v0.9.10-internal exactly as staged (47 files); the three outward acts
remain: create mentu-ai repo + push staged subtree, arXiv submission
(cs.SE primary, cs.AI cross-list), locator addendum within 72h of ID.
